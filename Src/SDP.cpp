    ...
    if(choice=='D'||choice=='d'){
       cout<<"Your answer is correct"<<endl<<endl;
        ...
        cout<<"The correct answer is d"<<endl<<endl;
            ...
            break;
      case 2:
     cout<<i+1<<")whis operator can not be overloaded?"<<endl;
...
void English(){
    system("CLS");
     cout<<"\t\tEnglish,Fill in the blanks with appropriate words"<<endl;
    char choice;
    st.marks=0;
    int i=0,arr[5];
    while(i<6 ){
...
do{
        ...
        gets(st.department);
        system("CLS");
        cout<<"\t\tMarks less than 50% will be considered as fail"<<endl;
    ...
    cout<<"Press C to to continue or any key to terminate"<<endl;
    press=getch();
    system("CLS");
